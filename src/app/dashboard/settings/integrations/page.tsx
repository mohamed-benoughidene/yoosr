...
const INTEGRATIONS = [
    ...
    { id: "messenger", name: "Messenger", description: "Facebook Messenger via Meta Graph API", category: "channel", icon: "💬", color: "bg-indigo-100 text-indigo-700", locked: true, fields: [{ key: "page_id", label: "Page ID", type: "text", placeholder: "Page ID" }, { key: "access_token", label: "Access Token", type: "password", placeholder: "EAA..." }], instructions: "Create an app at developers.facebook.com." },
    { id: "instagram", name: "Instagram", description: "Instagram DMs via Meta Graph API", category: "channel", icon: "📸", color: "bg-fuchsia-100 text-fuchsia-700", locked: true, fields: [{ key: "page_id", label: "Account ID", type: "text", placeholder: "Account ID" }, { key: "access_token", label: "Access Token", type: "password", placeholder: "EAA..." }], instructions: "Connect your Professional Account." },
